        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                if self.ant.container:
                    ...
                    insect.place = None
                elif isinstance(insect, QueenAnt) and insect.true_queen:
                    pass
                else:
                    self.ant = None
                    insect.place = None
            else:
                if self.ant.container and self.ant.ant is insect:
                    if not (isinstance(insect, QueenAnt) and insect.true_queen):
                        self.ant.ant = None
                        insect.place = None
                    else:
                        pass
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 8
        if self.place.ant is not None and self.place.ant.block_path is True:
            return True
        return False
        # END Problem 8
...
class Ant(Insect):
    ...
    def can_contain(self, other):
        # BEGIN Problem 11
        if self.container:
            return self.ant is None and not other.container
        else:
            return False
        # END Problem 11
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while (not self.min_range <= dist <= self.max_range) or len(bees) == 0:
            if place.entrance is not hive:
...
# BEGIN Problem 7
class WallAnt(Ant):
    """An Ant the does nothing but has high armor"""
